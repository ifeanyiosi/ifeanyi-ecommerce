  ...
  return (
    <>
      ...
      >
        <div className="grid items-center justify-items-center">
          ...
          <div className="flex  items-center justify-between w-28 my-2">
            ...
            <div className="flex  items-center gap-1 ">
              <AiFillStar style={{ Color: 'white' }} className="h-6 w-6 sm:h-5 sm:w-5 cursor-pointer
        ...
        <div>
          <img className="h-36 w-64 trasitions-theme hover:-rotate-12" src={img} alt="img/item-img" />
        </div>
      </div>
    </>
  );
